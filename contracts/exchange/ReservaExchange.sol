 ...
 *
 * See https://github.com/privatefoundation/erc20-meta-token for a generalized
 ...
 *    https://github.com/privatefoundation/multi-token-standard/tree/master/contracts/tokens/ERC1155
 *
 ...
 */
contract ReservaExchange is ReentrancyGuard, ERC1155MintBurn, ERC1155Meta {
  ...
  constructor(address _tokenAddr, address _currencyAddr, uint256 _currencyID) public {
    require(
      ...
      "ReservaExchange#constructor:INVALID_INPUT"
    );
    factory = msg.sender;
    ...
    internal nonReentrant() returns (uint256[] memory currencySold)
  {
    ...
    for (uint256 i = 0; i < nTokens; i++) {
      ...
      require(amountBought > 0, "ReservaExchange#_currencyToToken: NULL_TOKENS_BOUGHT");
   ...
   * @return price Amount of currency tokens to send to Reserva.
   */
    ...
    public pure returns (uint256 price)
  {
    ...
    require(_assetSoldReserve > 0 && _assetBoughtReserve > 0, "ReservaExchange#getBuyPrice: EMPTY_RESERVE");
    ...
    internal nonReentrant() returns (uint256[] memory currencyBought)
  {
    ...
    for (uint256 i = 0; i < nTokens; i++) {
      ...
      require(amountSold > 0, "ReservaExchange#_tokenToCurrency: NULL_TOKENS_SOLD");
    ...
    require(totalCurrency >= _minCurrency, "ReservaExchange#_tokenToCurrency: INSUFFICIENT_CURRENCY_AMOUNT");
   ...
   * @return price Amount of currency tokens to receive from Reserva.
   */
  ...
  {
    //Reserves must not be empty
    require(_assetSoldReserve > 0 && _assetBoughtReserve > 0, "ReservaExchange#getSellPrice: EMPTY_RESERVE");
    ...
    return numerator / denominator; //Rounding errors will favor Reserva, so nothing to do
  }
    ...
    internal nonReentrant()
  {
    ...
    for (uint256 i = 0; i < nTokens; i ++) {
      ...
      require(_maxCurrency[i] > 0, "ReservaExchange#_addLiquidity: NULL_MAX_CURRENCY");
      require(amount > 0, "ReservaExchange#_addLiquidity: NULL_TOKENS_AMOUNT");

      // If the token contract and currency contract are the same, prevent the creation
      // of a currency pool.
      if (currencyPoolBanned) {
        require(tokenId != currencyID, "ReservaExchange#_addLiquidity: CURRENCY_POOL_FORBIDDEN");
      }
      ...
      if (totalLiquidity > 0) {
        ...
        */
        ...
        require(_maxCurrency[i] >= currencyAmount, "ReservaExchange#_addLiquidity: MAX_CURRENCY_AMOUNT_EXCEEDED");
        ...
        require(maxCurrency >= 1000000000, "ReservaExchange#_addLiquidity: INVALID_CURRENCY_AMOUNT");
    ...
    internal nonReentrant()
  {
    ...
    // Assumes RESERVA liquidity tokens are already received by contract, but not
    ...
    for (uint256 i = 0; i < nTokens; i++) {
      ...
      require(totalLiquidity > 0, "ReservaExchange#_removeLiquidity: NULL_TOTAL_LIQUIDITY");
      ...
      require(currencyAmount >= _minCurrency[i], "ReservaExchange#_removeLiquidity: INSUFFICIENT_CURRENCY_AMOUNT");
      require(tokenAmount >= _minTokens[i], "ReservaExchange#_removeLiquidity: INSUFFICIENT_TOKENS");
    ...
    public returns(bytes4)
  {
    ...
    // Users must be responsible and only use this Reserva exchange
    ...
    if (functionSignature == BUYTOKENS_SIG) {
      ...
      require(msg.sender == address(currency), "ReservaExchange#onERC1155BatchReceived: INVALID_CURRENCY_TRANSFERRED");
      require(_ids.length == 1, "ReservaExchange#onERC1155BatchReceived: INVALID_CURRENCY_IDS_AMOUNT");
      require(_ids[0] == currencyID, "ReservaExchange#onERC1155BatchReceived: INVALID_CURRENCY_ID");
    ...
    |__________________________________*/
      ...
      require(msg.sender == address(token), "ReservaExchange#onERC1155BatchReceived: INVALID_TOKENS_TRANSFERRED");
    ...
    |__________________________________*/
      ...
      require(msg.sender == address(token), "ReservaExchange#onERC1155BatchReceived: INVALID_TOKEN_TRANSFERRED");
    ...
    |__________________________________*/
      ...
      // Tokens received need to be RESERVA-1155 tokens
      require(msg.sender == address(this), "ReservaExchange#onERC1155BatchReceived: INVALID_RESERVA_TOKENS_TRANSFERRED");
    ...
    |__________________________________*/
      ...
      require(msg.sender == address(currency), "ReservaExchange#onERC1155BatchReceived: INVALID_TOKENS_DEPOSITED");
      require(_ids[0] == currencyID, "ReservaExchange#onERC1155BatchReceived: INVALID_CURRENCY_ID");

    } else {
      revert("ReservaExchange#onERC1155BatchReceived: INVALID_METHOD");
    }
    ...
    public returns(bytes4)
  {
    ...
    require(
      ...
      "ReservaExchange#onERC1155Received: INVALID_ONRECEIVED_MESSAGE"
    );
   ...
   */
  fallback () external {
    revert("ReservaExchange:UNSUPPORTED_METHOD");
  }
    ...
    internal view returns (uint256[] memory)
  {
    ...
    if (nTokens == 1) {
      ...
      for (uint256 i = 1; i < nTokens; i++) {
        require(_tokenIds[i-1] < _tokenIds[i], "ReservaExchange#_getTokenReserves: UNSORTED_OR_DUPLICATE_TOKEN_IDS");
