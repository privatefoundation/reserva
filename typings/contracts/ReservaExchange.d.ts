...
interface ReservaExchangeInterface extends Interface {
  functions: {
...
export class ReservaExchange extends Contract {
  connect(signerOrProvider: Signer | Provider | string): ReservaExchange;
  attach(addressOrName: string): ReservaExchange;
  deployed(): Promise<ReservaExchange>;

  on(event: EventFilter | string, listener: Listener): ReservaExchange;
  once(event: EventFilter | string, listener: Listener): ReservaExchange;
  addListener(
    eventName: EventFilter | string,
    listener: Listener
  ): ReservaExchange;
  removeAllListeners(eventName: EventFilter | string): ReservaExchange;
  removeListener(eventName: any, listener: Listener): ReservaExchange;

  interface: ReservaExchangeInterface;
