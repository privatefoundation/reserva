...
interface IReservaExchangeInterface extends Interface {
  functions: {
...
export class IReservaExchange extends Contract {
  connect(signerOrProvider: Signer | Provider | string): IReservaExchange;
  attach(addressOrName: string): IReservaExchange;
  deployed(): Promise<IReservaExchange>;

  on(event: EventFilter | string, listener: Listener): IReservaExchange;
  once(event: EventFilter | string, listener: Listener): IReservaExchange;
  addListener(
    eventName: EventFilter | string,
    listener: Listener
  ): IReservaExchange;
  removeAllListeners(eventName: EventFilter | string): IReservaExchange;
  removeListener(eventName: any, listener: Listener): IReservaExchange;

  interface: IReservaExchangeInterface;
