...
import { IReservaExchange } from "./IReservaExchange";

export class IReservaExchangeFactory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IReservaExchange {
    return new Contract(address, _abi, signerOrProvider) as IReservaExchange;
  }
}
